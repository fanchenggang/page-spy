...
export default class Request {
  ...
  createRoom() {
    ...
    var request = getMPSDK().request<TResponse<TCreateRoom>>;
    return promisifyMPApi(request)({
      ...
      (res) => {
        const { name, address } = JSON.parse(res!.data as string).data;
